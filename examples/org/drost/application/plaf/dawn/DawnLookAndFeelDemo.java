 ...
 *
 */
public class DawnLookAndFeelDemo extends JFrame
{
	public DawnLookAndFeelDemo(String title)
	{
		this.setTitle(title);
...
//		x.setPreferredSize(new Dimension(200, 150));
	...
	public static void main(String[] args) throws InterruptedException, InvocationTargetException 
	{
		...
		app.getAppearance( ).setConsistentLookAndFeel( );
		
		DawnLookAndFeelDemo view = new DawnLookAndFeelDemo("");
		app.getAppearance( ).setMainView( view );
