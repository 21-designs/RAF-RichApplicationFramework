...
public class ConflictInfo<T> implements Serializable
{
	 ...
	 * @param owner
	 */
	public ConflictInfo(final T source, final Thread owner)
	{
		this.soure = source;
		this.owner = owner;
	...
	public ConflictInfo(T source, Thread ownerThread, long when)
	{
		this.soure = source;
