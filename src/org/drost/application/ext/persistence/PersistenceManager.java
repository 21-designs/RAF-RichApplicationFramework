 ...
 */
package org.drost.application.ext.persistence;
 ...
 * {@link Local} instance which may be initialized by either an
...
//	private String dataDirectory = "";	// TODO Create getters and setters
	 ...
	 * {@link PersistenceManager#getStateables()} ).
	 * 
	 * @author kimschorat
	 * 
	 * @since 1.0
	...
	protected class StateGetter implements StateOperation<Map<String, Object>>
	{
		...
		public Map<String, Object> operate(Property p, Component c, Map<String, Object> stateMap) 
		{
			...
			if(!isNull(state))
			{
				String key = PersistenceManager.this.getComponentName(c);
				if(!isNull(key))
				{
	 ...
	 * 
	 * @see PersistenceManager#iterateComponentHierarchy(List, Map, StateOperation)
	 */
	protected final StateOperation<Map<String, Object>> GET_VIEW_STATE = PersistenceManager.this.new StateGetter();
	 ...
	 * @see PersistenceManager#iterateComponentHierarchy(List, Map, StateOperation)
	 */
	protected final StateOperation<Void> SET_VIEW_STATE = PersistenceManager.this.new StateSetter();
...
//	 * {@link Local storage} to handle file storage.
//	 * 
//	 * @param storage
//	 *            Object to handle local file storage.
//	 */
//	public PersistenceManager(Local storage)
//	{
...
//	}
	 ...
	 * handle file storage.
	 * 
	 * @see Local#getSystemDefaultDirectory()
	 */
	public PersistenceManager()
	{
		storage = new Local(/*Local.getSystemDefaultDirectory()*/);
...
//	}
	...
	public Local getStorage() {
		return storage;
	}


	public void setStorage(Local storage) {
		this.storage = storage;
	}
...
//    }
	 ...
	 * or the user settings applied to the {@link Local}.
	 * 
	 * @param stateMap
