...
public abstract class AbstractInactivityHandler implements StateChangeHandler<Void>
{
	...
	Timer inactiveTimer = new Timer(0, new ActionListener() {
		...
		{
			inactive = true;
			handle(new StateChangeInfo<Void>(null, Thread.currentThread()));
		}
	});
	 ...
	 */
	@Override
	public abstract void handle(StateChangeInfo<Void> info);
