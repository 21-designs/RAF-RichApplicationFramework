 ...
 *
 * @param <T>
 *            The generic source type of the {@link StateChangeInfo}.
 */
public interface StateChangeHandler<T> extends Serializable
{
	/**
	 ...
	 */
	public void handle(final StateChangeInfo<T> info);
