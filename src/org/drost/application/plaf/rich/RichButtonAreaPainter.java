 ...
 *
 */
class RichButtonAreaPainter extends AbstractPainter<AbstractButton>
{
	protected boolean pressed, enabled, mouseOver;
	
	
	RichButtonAreaPainter( boolean pressed, boolean enabled, boolean mouseOver )
	{
	...
	public void paint( Graphics2D g, AbstractButton object, int width, int height )
	{
		...
		if(object.isBorderPainted( ) == false)
			return;
