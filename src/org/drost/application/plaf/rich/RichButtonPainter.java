 ...
 *
 */
final class RichButtonPainter extends AbstractPainter<AbstractButton>
{
	private Painter<AbstractButton> focusPainter;
	private Painter<AbstractButton> borderPainter;
	private Painter<AbstractButton> areaPainter;
	
	RichButtonPainter(Painter<AbstractButton> focusPainter, Painter<AbstractButton> borderPainter, Painter<AbstractButton> areaPainter)
	{
