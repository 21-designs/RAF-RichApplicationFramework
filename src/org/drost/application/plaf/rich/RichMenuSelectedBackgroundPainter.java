 ...
 *
 */
final class RichMenuSelectedBackgroundPainter extends AbstractPainter<Component>
{
	RichMenuSelectedBackgroundPainter()
	{
	...
	public void paint( Graphics2D g, Component object, int width, int height )
	{
		...
		GradientPaint gradient = new GradientPaint(0, 0, theme.getFocus( ).brighter( ), 0, height, theme.getFocus() );
		g.setPaint( gradient );
